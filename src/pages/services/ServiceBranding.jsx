...
import filmImage from "../../assets/Services/Branding.png";

import vector3 from "../../assets/Vector 5.svg";
import camera1 from "../../assets/Services/Branding Vector 01.svg";
import camera2 from "../../assets/Services/Branding Vector 02.svg";
import camera3 from "../../assets/Services/Branding Vector 03.svg";
import camera4 from "../../assets/Services/Branding Vector 04.svg";
  ...
  return (
    <section className="relative bg-[#fffaf5] min-h-screen px-6 md:px-20 py-20 overflow-visible font-poppins">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-16 md:gap-24 relative z-[20]">
        ...
        >
          <p>
            Our branding service helps businesses develop their voice, vision,
            and visual identity. We build cohesive brand experiences that
            connect with audiences across all touchpoints.
          </p>
          <p className="font-medium">V crafts:</p>
          <ul className="list-disc list-inside space-y-2">
            <li>Logo & visual identity creation</li>
            <li>Brand storytelling</li>
            <li>Customer engagement</li>
            <li>Social & digital brand management</li>
