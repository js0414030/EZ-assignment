...
import filmImage from "../../assets/Services/ArtCuration.jpg";
import vector3 from "../../assets/Vector 5.svg";
import camera1 from "../../assets/Services/Art Curation Icons 01.svg";
import camera2 from "../../assets/Services/Art Curation Icons 02.svg";
import camera3 from "../../assets/Services/Art Curation Icons 03.svg";
import camera4 from "../../assets/Services/Art Curation Icons 04.svg";
    ...
    <section className="relative bg-[#fffaf5] min-h-screen px-6 md:px-20 py-20 overflow-visible font-poppins">
      ...
      >
        <h2 className="font-playfair italic text-lg md:text-2xl text-[#2e2e2e] relative z-[20]">
          “Color is the power to directly influence the soul.” – Wassily Kandinsky
        </h2>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-16 md:gap-24 relative z-[20]">
        ...
        >
          <p>
            Through our art curation and styling services, we channel creativity
            into visual storytelling. From gallery exhibitions to event setups,
            we help bring together artistic vision and design aesthetics that
            speak to emotions.
          </p>
